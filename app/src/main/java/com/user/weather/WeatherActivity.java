...
import com.user.weather.adapters.RecyclerViewAdapter;
import com.user.weather.database.DatabaseQuery;
import com.user.weather.entity.WeatherObject;
import com.user.weather.helpers.CustomSharedPreference;
import com.user.weather.helpers.Helper;
import com.user.weather.json.FiveDaysForecast;
import com.user.weather.json.FiveWeathers;
import com.user.weather.json.Forecast;
import com.user.weather.json.LocationMapObject;
